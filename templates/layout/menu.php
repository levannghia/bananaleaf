        ...
        <div class="fixwidth d-flex justify-content-between align-self-center flex-wrap">
            ...
            <div class="header_menu_top">
                <div class="diachi-top">
                    ...
                    <div class="menu">
                        <ul class="menu_cap_cha d-flex justify-content-center">
                            ...
                            <li class="menulicha <?= $com == 'thuc-don' ? 'active' : '' ?>"><a href="san-pham" title="Thực Đơn">THỰC ĐƠN</a>
                                <?php if ($splistmenu) { ?>
                            ...
                            <li class="menulicha <?= $com == 'hinh-anh' ? 'active' : '' ?>"><a href="hinh-anh" title="CÔNG TRÌNH">HÌNH ẢNH</a>
                                <?php if ($ctlistmenu) { ?>
                                    <ul class="menu_cap_con">
                ...
                <div class="logo_header">
                    <a class="header_logo" href=""><img onerror="this.src='<?= THUMBS ?>/0x200x2/assets/images/noimage.png';" src="<?= THUMBS ?>/0x200x2/<?= UPLOAD_PHOTO_L . $logo['photo'] ?>" /></a>
                </div>

                <div class="mxh_header">
                    <div class="thong_tin_header">
                        <p>Hotline: <?= $optsetting['hotline'] ?></p>
                        <div class="mxh">
                            <?php foreach ($social1 as $v) { ?>
                                <a href="<?= $v['link'] ?>" class="ftmxh" target="_blank" title="<?= $v['ten' . $lang] ?>"><img onerror="this.src='<?= THUMBS ?>/30x30x2/assets/images/noimage.png';" src="<?= THUMBS ?>/0x20x2/<?= UPLOAD_PHOTO_L . $v['photo'] ?>" alt="<?= $v['ten' . $lang] ?>" title="<?= $v['ten' . $lang] ?>" /></a>
                            <?php } ?>
                        </div>
                ...
                <!-- <p style="text-align: start;">Email: <?= $optsetting['email'] ?></p> -->
            </div>
        </div>
    </div>
</div>
