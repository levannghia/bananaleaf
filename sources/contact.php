<?php 
	...
	if(isset($_POST['submit-contact']))
	{
        ...
        if(($scoreCaptcha >= 0.5 && $actionCaptcha == 'contact') || $testCaptcha == true)
		{
			...
			if($emailer->sendEmail("admin", $arrayEmail, $subject, $message, $file) || true)
			{
				/* Send email customer */
				$arrayEmail = array(
					"dataEmail" => array(
				...
				if($emailer->sendEmail("customer", $arrayEmail, $subject, $message, $file) || true) $func->transfer("Gửi liên hệ thành công",$config_base);
			}
