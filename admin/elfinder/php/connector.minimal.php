...
$opts = array(
	...
	'roots' => array(
		...
		array(
			...
			'uploadAllow'   => array('image/x-ms-bmp','video/mp4','image/gif', 'image/jpeg', 'image/png', 'image/x-icon', 'text/plain'), // Same as above
